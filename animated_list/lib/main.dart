...
class _AnimatedListExampleState extends State<AnimatedListApp> {
  ...
  //Use to build list items that haven't beed removed.
    ...
    return new MaterialApp(
      home: new Scaffold(
        appBar: new AppBar(
          ...
          actions: <Widget>[
            new IconButton(icon: const Icon(Icons.add_circle),
              onPressed: _insert,
              tooltip: 'insert a new item',
            ),
            new IconButton(icon: const Icon(Icons.remove_circle),
              onPressed: _remove,
...
class CardItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return new Padding(
      ...
      child: new SizeTransition(axis: Axis.vertical,
